...
def seeker_user():
    return User.objects.create_user(
        username="seeker", password="password123", role="seeker"
    )
...
def other_user():
    ...
    return User.objects.create_user(
        username="otheruser", password="password123", role="seeker"
    )
...
class TestProfileAccess:
    def test_get_profile_list_shows_only_own_profile(
        self, api_client, seeker_user, other_user
    ):
    ...
    def test_cannot_access_other_user_profile_detail(
        self, api_client, seeker_user, other_user
    ):
